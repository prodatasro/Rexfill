  ...
  satellite: {
    ...
    collections: {
      datastore: [
        ...
        { collection: 'organizations', read: 'private', write: 'private', memory: 'stable' },
        { collection: 'organization_members', read: 'private', write: 'private', memory: 'stable' },
        { collection: 'organization_invitations', read: 'private', write: 'private', memory: 'stable' },
