...
export interface FileListItemProps {
  ...
  onPreview: (template: Doc<WordTemplateData>) => void;
      ...
      >
        ...
        >
          <button
            ...
            disabled={isDeleting}
            className="p-1.5 text-indigo-500 hover:text-indigo-700 hover:bg-indigo-50 dark:hover:bg-slate-700 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            title={t('fileList.previewTemplate')}
            aria-label={t('fileList.previewTemplate')}
          >
