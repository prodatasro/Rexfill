...
import { User, Mail, Upload, Trash2, Save, Download, ArrowLeft } from 'lucide-react';
import { useAuth } from '../../contexts';
import { useUserProfile } from '../../contexts/UserProfileContext';
import { ActivityLogViewer } from '../../components/profile';
import { GDPRExportDialog } from '../../components/dialogs/GDPRExportDialog';
...
const ProfilePage: FC = () => {
  ...
  const { user } = useAuth();
  const { profile, loading, updateProfile, uploadAvatar, removeAvatar } = useUserProfile();
        ...
        <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-6 sm:p-8">
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="text-sm text-slate-900 dark:text-slate-50 font-mono bg-slate-100 dark:bg-slate-700 p-2 rounded mt-1 break-all">
                {user.key}
              </p>
            </div>
          </div>
